...
function openPaywall(item){state.current=item;document.getElementById('payTitle').textContent=item.title;document.getElementById('singlePrice').textContent=item.price||'Plano Pro';const cc=document.getElementById('couponCode');if(cc)cc.value='';document.getElementById('paywall').classList.add('show');document.getElementById('overlay').classList.add('show')}
