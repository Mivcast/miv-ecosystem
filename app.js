...
setTimeout(()=>{loadSubscriptionPlans();const a=document.getElementById('planProBtn'),b=document.getElementById('planPremiumBtn'),c=document.getElementById('clearSubscriptionCoupon');if(a)a.onclick=()=>startSubscription('pro');if(b)b.onclick=()=>startSubscription('premium');if(c)c.onclick=()=>{const input=document.getElementById('subscriptionCoupon');if(input)input.value=''}},300);
