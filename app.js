...
async function refreshCompetitors(suggest=false,channel=''){
 ...
 try{
  ...
  if(btn){btn.disabled=true;btn.textContent=suggest?'Sugerindo...':channel?`Atualizando ${channel}...`:'Atualizando canais...'}
  ...
  if(suggest){
   ...
   toast(suggested.length?'Concorrentes sugeridos e salvos. Você pode remover, adicionar ou atualizar os canais.':'Não encontrei sugestões claras; digite nomes para analisar.');
   return
  }
